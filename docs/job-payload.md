...
-   `timeout` - This is a timeout in seconds after which the job will be terminated. There's a hard limit in [fastlane](https://github.com/heynemann/fastlane) and it will use whatever value is lower.
